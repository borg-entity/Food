                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                     ...
                     <?php else: ?>
                           ...
                           <p class="card-text">
                                <span class="font-weight-bold text-danger mr-2">Excluído:</span>
                                <?php echo $usuario->deletado_em->humanize(); ?>
                           </p>

                           <a href="<?php echo site_url("admin/usuarios/desfazerExclusao/$usuario->id"); ?>" class="btn-dark  btn-sm mr-2"> 
                              <i class="mdi mdi-undo plus btn-icon-prepend"></i>
                                 Desfazer
                           </a>
